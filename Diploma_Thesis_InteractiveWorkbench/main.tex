...
First and foremost, we want to take a moment to thank everyone that helped us along our journey of the development of the "Interactive Workbench" and the writing of the diploma thesis. 
We appreciate each and everyone who helped us overcome problems, find solutions and make the overall project better. 

Firstly, we want to thank our advisor Professor Gerald Senarclens de Grancy who influenced our project with his incredible knowledge and expertise which helped us bring this project to life. 

Without these people, our success in bringing this project and writing a good technical thesis about it would have been doubtable. 
\section{Preword}
Modern laptops are often come with touchscreens, which allows the user to use them like tablets, write on them with a pen or just enjoy the freedom that comes from a device that always needs a keyboard and a mouse to function properly.
But, there has to be more to it, atleast that is what we thought when we came up with the possibility of expoloring the capabilities of touch-screen laptops as our final project and diploma thesis. 

Inspired by the project of famous youtuber and influencer "ConceptBytes", who himself build an entire workbench from the ground up himself, we decided to try our best at a somewhat similar but mostly different project. 
In contrast to him, we were only two people and a time span of about a year to work with, while he had an entire development team and financial mediums that we dont.  

This quickly made us realize that what we wanted to do had to be different, and that the ouput would not be comparable. 
So we settled on software development in itself as the one and only focus, not an entire physical workbench which is enhanced by tech. 

The motivation was that, we wanted to proof that if you have a dream, the right people and the right mindset and motivation, you can achieve great things, even in little time. 
