...
In the end, the decision to use the "Audio H5 player" was made because of the clear advantages when compared to the other options, especially considering the financial constraints of a student project and the legal and privacy concerns encountered with third-party streaming services.
...
\begin{notebox}
More information about the different audio file types can be found in the \textit{Bibliography}.  
\end{notebox}
